...
- Comenta na task e move status para CLICKUP_STATUS_DONE (default: concluída) se sucesso
"""
...
CLICKUP_STATUS_DONE = (os.getenv("CLICKUP_STATUS_DONE") or "concluída").strip().lower()
...
def task_candidata_basico(t, status_todo_real):
    ...
    return (norm(status_name) == norm(status_todo_real)) and (not assignees)
